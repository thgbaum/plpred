...
def generate_aa_composition_df(file_path, membrane_label):
    """
...
def main():
    ...
    argument_parser.add_argument('-c', '--cytoplasm_proteins', required=True, help='path to the file containing cytoplasm prteins')
