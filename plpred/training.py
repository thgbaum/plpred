...
def main():
    ...
    argument_parser.add_argument('-p', '--processed_dataset', required=True, help='processed datased generated by plpred-preprocess (.csv)')
    ...
    model, report = train_model(file_path=arguments.processed_dataset, model=models[arguments.algorithm]) #pra chamar/abrir o arquivo
